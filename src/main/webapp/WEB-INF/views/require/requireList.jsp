...
<input type="text" name="search2" id="materialCode" class="form-control search-input  readonly-color" placeholder="자재코드" style="width:110px;" readonly>
...
<%-- 		<input type="hidden" name="rematerialCode" id="rematerialCode" class="form-control search-input" value="${requireDTO.materialCode}"> --%>
    ...
    <td>${requireDTO.reqDate}</td>
    <td>${requireDTO.reqUpdate}</td>
<c:choose>    
