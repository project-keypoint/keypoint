...
<body id="page-top">
	...
	<div class="main">
		...
		<div class="card in-card">
			<div class="in-card-1 right" style="background: silver;">
				<a class="more-notice"
					href="${pageContext.request.contextPath}/main/main_test"
					 style="width:100%; height:100%; background: #fff; margin: 0 0 0 0; border: 1px solid black">테스트 메인페이지로(클릭)</a>
			</div>
			<div class="in-card-2 right">
				<a class="more-notice"
					href="${pageContext.request.contextPath}/notice/noticeList">더보기</a>
				<table>
					<tr>
		...
		<h4>출하현황</h4>
		<div class="card in-card">
			<div class="in-card-1 left">
				<h6>매월출고량</h6>
				<!--차트가 그려질 부분-->
				<canvas id="myChart" class="main-chart"></canvas>
			</div>
			
			<div class="in-card-2 left">
				<h6>출고품목비율</h6>
		 		<!-- 차트가 그려질 부분 -->
		...
		<div class="card in-card" style="display: none;">
			<div class="in-card-2 left">
				<h6>제품별판매량</h6>
				<!--차트가 그려질 부분-->
