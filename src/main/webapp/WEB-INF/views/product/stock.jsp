...
<input type="button" id="productjoin" value="상품추가" onclick ="window.open('${pageContext.request.contextPath}/product/addstock', '상품추가', 'width = 800, height = 600, left = (screen.width - width) / 2, top = (screen.height - height) / 2');">
