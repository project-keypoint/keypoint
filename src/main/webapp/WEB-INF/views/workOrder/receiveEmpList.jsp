	...
	<div class="center">
		<div id="pagination">
			...
			<c:if test="${pageDTO.currentPage > 1}">
				<a
					href="${pageContext.request.contextPath }/workOrder/receiveEmpList?empId=${search.empId}&empName=${search.empName}&pageNum=${pageDTO.currentPage-1}"><</a>
			</c:if>

			<!-- 10페이지 이전 -->
			<c:if test="${pageDTO.startPage > pageDTO.pageBlock}">
				<a
					href="${pageContext.request.contextPath }/workOrder/receiveEmpList?empId=${search.empId}&empName=${search.empName}&pageNum=${pageDTO.startPage-PageDTO.pageBlock}"><<</a>
			</c:if>
